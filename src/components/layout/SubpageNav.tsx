...
export function SubpageNav({ activeHref }: SubpageNavProps) {
  return (
    <nav
      aria-label="Primary"
      className="flex items-center justify-between gap-0 font-mono text-[9px] uppercase tracking-normal min-[360px]:gap-1 min-[360px]:text-[11px] sm:gap-2 sm:text-xs sm:tracking-widest"
    >

...
import { NowPortraitToggle } from "./NowPortraitToggle";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-[1fr_2fr_1fr] gap-16 lg:gap-16">
        ...
        <div className="flex flex-col" data-reveal="idle">
          {/* Desktop View */}
          ...
          <NowPortraitToggle
            ...
            imageAlt="Professional headshot of Josh Blyskal, Head of AI Strategy & Research at Profound"
          />
        </div>
        ...
        <div data-reveal="idle">
          ...
          <div className="space-y-6 text-lg font-body leading-relaxed text-foreground/90">
            <p>
              ...
              , he guides Fortune 500 companies like Ramp, Indeed, and US Bank on securing
              visibility in AI Answer Engines.
            </p>
            <p>
              Previously at <strong className="font-semibold">HubSpot</strong>, Josh co-founded
              the Marketing AI practice and built the AI Search Grader tool. His background blends
              technology, marketing, and entrepreneurship—from founding a streetwear brand in
              college to engineering AI automations that reached millions.
            </p>
            <p>
              Based in NYC, he is a recognized thought leader frequently sharing data-driven
        ...
        <div data-reveal="idle">
          ...
          <ul className="space-y-0 font-mono text-sm">
            <li>
              <a
                href="https://linkedin.com/in/joshuablyskal"
                target="_blank"
            ...
            <li>
              <a
                href="https://speakerdeck.com/joshbly"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-between py-4 border-b border-foreground/20 hover:bg-foreground/5 px-2 -mx-2 transition-colors"
              >

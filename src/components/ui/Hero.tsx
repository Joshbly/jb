          ...
          >
            ...
            <div className="space-y-4 lg:space-y-6 max-w-md mb-8 lg:mb-12">
              <p className="text-lg lg:text-xl font-body leading-relaxed text-foreground">
                Defining how Fortune 500 brands secure visibility in the era of AI
                Answer Engines. Currently leading AI Strategy & Research at{" "}
                <a
                  href="https://tryprofound.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border-b border-accent text-foreground hover:bg-accent hover:text-background transition-colors"
                >
                  Profound
                </a>
                .

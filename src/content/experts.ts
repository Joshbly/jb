...
export const aeoExperts: readonly AeoExpert[] = [
  ...
  },
  {
    ...
    slug: "josh-blyskal",
    name: "Josh Blyskal",
    role: "Leads AI Strategy & Research at Profound",
    ...
    profile: [
      "The term Answer Engine Optimization predates Profound. Josh's contribution was turning it into a modern operating practice at one of the earliest companies built around answer-engine visibility. He was among the first practitioners working on AEO full time, developed Profound's methodology from the ground up, and created the SAGE Framework now taught through Profound University.",
